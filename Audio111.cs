...
namespace kysSharp
{
    internal unsafe class Audio111 : IDisposable
    {
        ...
        public void Init()
        {
            ...
            audioDeviceId = SDL3.SDL_AUDIO_DEVICE_DEFAULT_PLAYBACK;



            // 创建混音器设备
            mixer = (nint)SDL3_mixer.MIX_CreateMixerDevice(audioDeviceId, &spec);
            ...
            for (int i = 1; i < 24; i++)
            {
                ...
                string path = Path.Combine("..", "game", "music0", i.ToString() + ".wav");
                pathBytes = Encoding.UTF8.GetBytes(path + '\0');
                // 固定字节数组以获取指针
        ...
        */
        ...
        public void playMusic(int num)
        {
            ...
            */
            SDL3_mixer.MIX_PlayAudio((MIX_Mixer*)mixer, (MIX_Audio*)music[num]);
        }
